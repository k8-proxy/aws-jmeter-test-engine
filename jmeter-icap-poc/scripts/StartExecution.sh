...
sudo JVM_ARGS="-Xms9216m -Xmx9216m" sh jmeter.sh -n -t $SCRIPT -Jp_vuserCount=3000 -Jp_filetype=$DATA_FILE -Jp_rampup=300 -Jp_duration=900 -Jp_aws_access_key=$ACCESS_KEY -Jp_aws_secret_key=$SECRET_KEY -Jp_bucket=$TEST_DATA_BUCKET -Jp_influxHost=10.112.0.112 -Jp_aws_region=$REGION -Jp_url=gw-icap01.westeurope.azurecontainer.io -Jp_prefix= -l icaptest-s33.log
