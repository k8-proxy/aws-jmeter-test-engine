...
export class ResultsTableComponent implements OnInit {
  ...
  displayedColumns: string[] = ['testName', 'startTime', 'endTime', 'duration', 'totalUsers', 'totalRequests', 'successfulRequests', 'failedRequests', 'averageResponseTime']; //add and remove columns here before adding/remove in html
  testsExist: boolean;
